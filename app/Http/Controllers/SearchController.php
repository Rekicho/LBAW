...
class SearchController extends Controller
{
    ...
    {   
		...
		if($order == "DESC")		
			$products = Product::search($search)->where($match)->orderByRaw("price DESC")->paginate(16);

		else if($order == "ASC")
			$products = Product::search($search)->where($match)->orderByRaw("price ASC")->paginate(16);
